namespace ProcessingTools.Bio.Harvesters
{
    ...
    public class BiorepositoryInstitutionHarvester : IBiorepositoryInstitutionHarvester
    {
        ...
        public BiorepositoryInstitutionHarvester(IBiorepositoriesDataService service)
        {
            this.service = service;
        }

        public Task<IQueryable<IBiorepositoryInstitution>> Harvest(string content)
        {
