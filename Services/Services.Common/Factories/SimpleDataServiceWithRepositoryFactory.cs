namespace ProcessingTools.Services.Common.Factories
{
    ...
    public abstract class SimpleDataServiceWithRepositoryFactory<TDbModel, TServiceModel> : RepositoryDataServiceFactory<TDbModel, TServiceModel>, IDataService<TServiceModel>, IDisposable
    {
