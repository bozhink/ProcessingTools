...
namespace ProcessingTools.Extensions.Tests.Unit.Tests.Linq.Dynamic
{
    ...
    public class DynamicExpressionsCultureTests
    {
        ...
        public void Parse_TypedLiteral_ShouldReturnCorrespondingTypeExpression(Type type, string literal, object value)
        {
            ...
            // Assert
            Assert.AreEqual(type, expression.Type, "Expression type mismatch");
            Assert.AreEqual(value, expression.Value, "Expression value mismatch");
        }
        ...
        public void Parse_DecimalLiteral_ShouldReturnDecimalTypeExpression(string literal, double value)
        {
            ...
            // Assert
            Assert.AreEqual(typeof(decimal), expression.Type, "Expression type mismatch");
            Assert.AreEqual((decimal)value, expression.Value, "Expression value mismatch");
        }
    }
}
