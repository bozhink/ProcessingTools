...
namespace ProcessingTools.Common.Exceptions
{
    ...
    public class InvalidDataException : Exception
    {
        ...
        public InvalidDataException()
            : base(message: StringResources.InvalidData)
        {
        }
        ...
        public InvalidDataException(string message)
            : base(message: $"{StringResources.InvalidData}{Environment.NewLine}{message}")
        {
        }
        ...
        public InvalidDataException(string message, Exception innerException)
            : base(message: $"{StringResources.InvalidData}{Environment.NewLine}{message}", innerException: innerException)
        {
        }
