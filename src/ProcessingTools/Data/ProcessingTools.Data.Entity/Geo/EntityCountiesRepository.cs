// <copyright file="EntityCountiesRepository.cs" company="ProcessingTools">
...
namespace ProcessingTools.Data.Entity.Geo
{
    ...
    public class EntityCountiesRepository : AbstractGeoSynonymisableRepository<County, ICounty, ICountiesFilter, CountySynonym, ICountySynonym, ICountySynonymsFilter>, ICountiesRepository
    {
        private readonly IMapper mapper;

        public EntityCountiesRepository(IGeoRepository<County> repository, IGeoRepository<CountySynonym> synonymRepository, IApplicationContext applicationContext)
            : base(repository, synonymRepository, applicationContext)
        {
            var mapperConfiguration = new MapperConfiguration(c =>
            {
                ...
                c.CreateMap<ICountySynonym, CountySynonym>()
                    .ForMember(d => d.County, o => o.Ignore())
                    .ForMember(d => d.CountyId, o => o.MapFrom(x => x.ParentId))
                    .ForMember(d => d.CreatedBy, o => o.Ignore())
                    .ForMember(d => d.CreatedOn, o => o.Ignore())
                    .ForMember(d => d.ModifiedBy, o => o.Ignore())
                    .ForMember(d => d.ModifiedOn, o => o.Ignore());
                ...
                c.CreateMap<County, ICounty>()
                    .ConstructUsing(m => new CountyModel
                    {
                        Id = m.Id,
                        Name = m.Name,
                ...
                c.CreateMap<CountySynonym, ICountySynonym>()
                    .ConstructUsing(s => new CountySynonymModel
                    {
                        Id = s.Id,
                        Name = s.Name,
                        LanguageCode = s.LanguageCode,
