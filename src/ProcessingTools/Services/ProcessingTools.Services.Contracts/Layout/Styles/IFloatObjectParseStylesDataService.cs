...
namespace ProcessingTools.Services.Contracts.Layout.Styles
{
    ...
    /// </summary>
    public interface IFloatObjectParseStylesDataService : IDataService<IFloatObjectParseStyleModel, IFloatObjectDetailsParseStyleModel, IFloatObjectInsertParseStyleModel, IFloatObjectUpdateParseStyleModel>
    {
    }
}
