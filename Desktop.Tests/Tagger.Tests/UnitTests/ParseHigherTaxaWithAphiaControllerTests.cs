namespace ProcessingTools.Tagger.Tests.UnitTests
{
    ...
    public class ParseHigherTaxaWithAphiaControllerTests
    {
        ...
        {
            var controller = new ParseHigherTaxaWithAphiaController(this.documentFactory, this.parser);
        ...
        public void ParseHigherTaxaWithAphiaController_WithNullService_ShouldThrowArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(
                () =>
                {
                    var controller = new ParseHigherTaxaWithAphiaController(this.documentFactory, null);
                },
