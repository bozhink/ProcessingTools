...
namespace ProcessingTools.Common.Exceptions
{
    ...
    {
        private const string DefaultMessage = "Insert operation is not successful.";
        ...
        public InsertUnsuccessfulException(SerializationInfo info, StreamingContext context)
