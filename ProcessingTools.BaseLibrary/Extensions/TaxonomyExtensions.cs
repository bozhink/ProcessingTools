namespace ProcessingTools.BaseLibrary
{
    ...
    public static class TaxonomyExtensions
    {
        ...
        public static IEnumerable<string> ExtractTaxa(this XmlNode xml, bool stripTags = false, TaxaType type = TaxaType.Any)
        {
            ...
            {
                XmlNodeList nodeList = xml.SelectNodes(xpath, TaxPubXmlDocument.NamespceManager());
                if (stripTags)
                {
        ...
        public static IEnumerable<string> GetListOfNonShortenedTaxa(this XmlNode xml)
        {
            ...
            XmlNamespaceManager nm = TaxPubXmlDocument.NamespceManager();
        ...
        public static IEnumerable<string> GetListOfShortenedTaxa(this XmlNode xml)
        {
            ...
            return new HashSet<string>(xml.GetStringListOfUniqueXmlNodes(xpath, TaxPubXmlDocument.NamespceManager()));
        }
        ...
        public static void RemoveTaxaInWrongPlaces(this XmlDocument xml)
        {
            ...
            foreach (XmlNode node in xml.SelectNodes(xpath, TaxPubXmlDocument.NamespceManager()))
            {
