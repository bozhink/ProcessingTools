// <copyright file="DocumentDeleteViewModel.cs" company="ProcessingTools">
...
namespace ProcessingTools.Web.Models.Documents.Documents
{
    ...
    {/// <summary>
     ...
     /// <param name="file">File of the document.</param>
        public DocumentDeleteViewModel(UserContext userContext, DocumentArticleViewModel article, DocumentFileViewModel file)
        {
