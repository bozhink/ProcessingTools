namespace ProcessingTools.Geo.Services.Data.Entity.Services
{
    ...
    public class EntityDistrictsDataService : AbstractGeoSynonymisableDataService<District, IDistrict, IDistrictsFilter, DistrictSynonym, IDistrictSynonym, IDistrictSynonymsFilter>, IEntityDistrictsDataService
    {
        private readonly IMapper mapper;

        public EntityDistrictsDataService(IGeoRepository<District> repository, IGeoRepository<DistrictSynonym> synonymRepository, IEnvironment environment)
