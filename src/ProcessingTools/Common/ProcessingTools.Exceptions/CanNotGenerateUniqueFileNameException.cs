...
namespace ProcessingTools.Exceptions
{
    ...
    {
        private const string DefaultMessage = "Can not generate unique file name.";
        ...
        public CanNotGenerateUniqueFileNameException(SerializationInfo info, StreamingContext context)
