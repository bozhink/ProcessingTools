// <copyright file="EntityGeoEpithetsRepository.cs" company="ProcessingTools">
...
namespace ProcessingTools.Data.Entity.Geo
{
    ...
    public class EntityGeoEpithetsRepository : AbstractGeoRepository<GeoEpithet, IGeoEpithet, ITextFilter>, IGeoEpithetsRepository
    {
        ...
        /// <inheritdoc/>
        public override async Task<IGeoEpithet[]> SelectAsync(ITextFilter filter, int skip, int take, string sortColumn, ProcessingTools.Common.Enumerations.SortOrder sortOrder)
        {
            var query = this.GetQuery(filter)
