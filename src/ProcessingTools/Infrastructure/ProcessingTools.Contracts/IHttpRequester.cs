...
namespace ProcessingTools.Contracts
{
    ...
    public interface IHttpRequester
    {
        ...
        /// <returns>The response as string.</returns>
        Task<string> GetStringAsync(string url, string acceptContentType);
        ...
        Task<T> GetJsonToObjectAsync<T>(string url)
            where T : class;
        ...
        Task<string> GetXmlAsync(string url);
        ...
        Task<T> GetXmlToObjectAsync<T>(string url)
            where T : class;
        ...
        Task<string> PostAsync(string url, string content, string contentType);
        ...
        /// <returns>Task of response string.</returns>
        Task<string> PostToStringAsync(string url, IDictionary<string, string> values);
        ...
        /// <param name="encoding">Encoding of the content string.</param>
        /// <returns>Task of response string.</returns>
        Task<string> PostToStringAsync(string url, IDictionary<string, string> values, Encoding encoding);
        ...
        Task<T> PostToXmlToObjectAsync<T>(string url, IDictionary<string, string> values)
            where T : class;
        ...
        /// <param name="encoding">Encoding of the content string.</param>
        /// <returns>Deserialize response XML string to object.</returns>
        Task<T> PostToXmlToObjectAsync<T>(string url, IDictionary<string, string> values, Encoding encoding)
            where T : class;
    }
}
