namespace ProcessingTools.Tagger.Tests.UnitTests
{
    ...
    public class TagAltitudesControllerTests
    {
        ...
        {
            var controller = new TagAltitudesController(this.miner, this.documentFactory, this.tagger);
        ...
        public void TagAltitudesController_WithNullService_ShouldThrowArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(
                () =>
                {
                    var controller = new TagAltitudesController(null, this.documentFactory, this.tagger);
                },
