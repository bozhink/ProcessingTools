// <copyright file="MediatypeDetailsViewModel.cs" company="ProcessingTools">
...
namespace ProcessingTools.Web.Models.Files.Mediatypes
{
    ...
    public class MediatypeDetailsViewModel : ProcessingTools.Models.Contracts.IWebModel
    {
        ...
        public MediatypeDetailsViewModel(UserContext userContext)
        {
        ...
        /// </summary>
        [Display(Name = "Mediatype Details")]
