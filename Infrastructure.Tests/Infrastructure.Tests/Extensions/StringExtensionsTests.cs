namespace ProcessingTools.Infrastructure.Extensions.Tests
{
    ...
    public class StringExtensionsTests
    {
        ...
        {
            Assert.AreEqual(1, "1".ConvertTo<int>(), "1 schould be int.");
            Assert.AreEqual(-10, "-10".ConvertTo<int>(), "-10 schould be int.");
        }
        ...
        public void ConvertToT_ShouldConvertStringToDouble()
        {
            Assert.AreEqual(
                ...
                "1.0 schould be double.");

            Assert.AreEqual(
                -10.0,
                "-10.0".Replace(".", this.decimalSeparator).ConvertTo<double>(),
                "-10.0 schould be double.");
        }

        [TestMethod]
        public void ConvertToType_ShouldConvertStringToInt()
        {
            Assert.AreEqual(1, "1".ConvertTo(typeof(int)), "1 schould be int.");
            Assert.AreEqual(-10, "-10".ConvertTo(typeof(int)), "-10 schould be int.");
        }
