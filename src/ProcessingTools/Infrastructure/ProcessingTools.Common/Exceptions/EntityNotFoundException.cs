// <copyright file="EntityNotFoundException.cs" company="ProcessingTools">
...
namespace ProcessingTools.Common.Exceptions
{
    ...
    public class EntityNotFoundException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityNotFoundException"/> class with a specified
        /// error message.
        /// </summary>
