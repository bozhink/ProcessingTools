      ...
      <front>
        ...
        <article-meta>
          <article-id pub-id-type="doi">
            <xsl:value-of select="/article/front/article-meta/note/article-id"/>
          </article-id>
          ...
          <issue>
            <xsl:value-of select="/article/front/article-meta/note/issue"/>
          </issue>
          <fpage>
            <xsl:value-of select="/article/front/article-meta/note/fpage"/>
          </fpage>
          <lpage>
            <xsl:value-of select="/article/front/article-meta/note/lpage"/>
          </lpage>
        ...
        <xsl:apply-templates mode="article-citations" select="/article/front/article-meta"/>
      </front>
