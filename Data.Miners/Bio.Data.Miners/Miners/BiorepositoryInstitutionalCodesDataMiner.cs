namespace ProcessingTools.Bio.Data.Miners
{
    ...
    public class BiorepositoryInstitutionalCodesDataMiner : IBiorepositoryInstitutionalCodesDataMiner
    {
        ...
        public async Task<IQueryable<BiorepositoryInstitutionalCode>> Mine(string content)
        {
            ...
            {
                var items = (await this.service.GetBiorepositoryInstitutionalCodes(i, NumberOfItemsToTake))
                    .ToList();
