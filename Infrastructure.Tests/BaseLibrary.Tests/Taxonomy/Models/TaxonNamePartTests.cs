namespace ProcessingTools.BaseLibrary.Tests.Taxonomy.Models
{
    ...
    public class TaxonNamePartTests
    {
        ...
        [TestCase(
            ...
            "",
            true)]
        public void TaxonNamePart_WithValidNodeParameterInConstructor_ShouldReturnValidObject(string nodeString, string taxonRank, string fullName, string taxonName, bool abbreviated)
        {
