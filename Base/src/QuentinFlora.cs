...
namespace Base
{
	public class QuentinFlora : Base
	{
		...
		public void Split2()
		{
			xml = Regex.Replace(xml, "(<family_header>[\\s\\S]*?)(?=<family_header>)", "<sec type=\"family\">\n$1\n</sec>\n");
			xml = Regex.Replace(xml, "(</sec>\\s*)(<family_header>[\\s\\S]*?)(?=</sec>)", "$1<sec type=\"family\">\n$2\n</sec>\n");
		}
